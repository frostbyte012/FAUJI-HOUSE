    ...
    return Scaffold(
      ...
      body: ListView( //SingleChildScrollView can be used as well.
        children: [
                  ...
                  child:Padding(
                    ...
                    child: TextField(
                      decoration: InputDecoration(
                        labelText: "ex. Search Properties,Categories.",
          ...
          Container(
            height: 500,
            child:CityLocationGridViewerSearch(),
          ),
          ...
          Padding(
            padding: EdgeInsets.all(10.0),
            child: Text("Latest Added Properties"),
          ),
...
class CityLocationGridViewerSearch extends StatefulWidget {
  const CityLocationGridViewerSearch({Key key}) : super(key: key);

  @override
  _CityLocationGridViewerSearchState createState() => _CityLocationGridViewerSearchState();
}

class _CityLocationGridViewerSearchState extends State<CityLocationGridViewerSearch> {
...
class LocationCitiesSearch extends StatelessWidget {


  final city_name;
  final city_picture;

  const LocationCitiesSearch({
    this.city_name,
    this.city_picture,
  });
